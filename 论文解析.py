...
from finall_function import 解析PDF
...
def parse_pdf():
    ...
    if None in result:
        # return jsonify({'success':'false','code': 20001, 'message': "失败", 'data': {"12":"121"}})
        return jsonify({'success': 'false', 'code': 20001, 'message': "失败", 'data': result})
        #return jsonify({'code': 20001, 'message': "失败", 'data': result})
    else:
        return jsonify({'success':'true','code': 20000, 'message': "成功", 'data': {"result":result,"result2":result}})
        #return jsonify({'code': 20000, 'message': "成功", 'data': result})
